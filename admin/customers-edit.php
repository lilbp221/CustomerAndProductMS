...
<div class="container-fluid px-4">
            ...
            <div class="card mt-4 shadow">
                  ...
                  <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="address" required value=" <?= $customer['data']['address']; ?>" class="form-control" />
                  ...
                  <div class="col-md-6 mb-3">
                       <button type="submit" name="updateCustomer" class="btn btn-primary"> Update
