 ...
 if($name != '')
  {
    ...
    if($emailCheck){
      if(mysqli_num_rows($emailCheck) >0)
      {
        redirect('customers.php','Email Already Exist For Another Customer');
      }
    }
...
if(isset($_POST['updateCustomer']))
{
 ...
 if($name != '')
 {
   ...
   if($emailCheck){
     if(mysqli_num_rows($emailCheck) >0)
     {
       redirect('customers-edit.php?id='.$customerId,'Email Already Exist For Another Customer');
     }
   }
 ...
 redirect('customers-edit.php?id='.$customerId,'Customer Update Successfully!!');
